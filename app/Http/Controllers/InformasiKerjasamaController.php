...
class InformasiKerjasamaController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('informasi-kerjasama.main', compact('data','bidang_kerjasama','jenis_kerjasama','status','list_bidang_kerjasama','list_jenis_kerjasama','list_status'));
    }
