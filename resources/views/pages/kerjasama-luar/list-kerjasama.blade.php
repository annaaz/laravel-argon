...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'List Data Kerjasama Luar Negri'])
        ...
        <div class="col-12">
            <div class="card mb-2" >
                <div class="card-header text-xs">
                    ...
                    <form method="GET" action="{{route('kerjasama-luar-negri')}}">
                                ...
                                <table style="width:100%;border-collapse: collapse; border: none" cellspacing="5" cellpadding="5" style="width: 100%" class="align-items-center mb-0">
                                    ...
                                    @foreach($data as $key => $value)
                                        <tr style="border-bottom: 1px solid lightgrey">
                                            ...
                                            <td>
                                                <a style="color: red;font-weight: bold" href=" {{ route('kerjasama-luar-negri.delete', ['id' => $value->id]) }}" data-confirm-delete="true">Delete</a>
                                                <a style="color: darkgreen;font-weight: bold"href=" {{ route('kerjasama-luar-negri.editview', ['id' => Crypt::encrypt($value->id)]) }}">Edit</a>
                                            </td>
