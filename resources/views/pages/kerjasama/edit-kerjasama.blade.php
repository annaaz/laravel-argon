...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Edit Data Kerjasama Dalam Negri'])
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="card">
                            <form action="{{ route('kerjasama.edit', ['id' => $kerjasamaModel->id]) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                @csrf
                                <div class="card-header pb-0">
                                    <div class="d-flex align-items-center">
                                        <p class="mb-0 font-bold">Edit Data Kerjasama Dalam Negri </p>
                                        <button type="submit" class="btn btn-primary btn-sm ms-auto">Save</button>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <p class="text-uppercase text-sm">Detail Info Kerjasama Dalam Negri </p>
                                    <div class="row">
                                        <div class="col-md-12">
