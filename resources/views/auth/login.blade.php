                    ...
                    <div class="row">
                                ...
                                <div class="card-body">
                                    <form role="form" method="POST" action="{{ route('login.perform') }}">
                                        ...
                                        <div class="flex flex-col mb-3">
                                            <input type="email" name="email" class="form-control" value="{{ old('email') ?? 'admin@argon.com' }}" aria-label="Email">
                                            @error('email') <p class="text-danger text-xs pt-1"> {{$message}} </p>@enderror
                                        </div>
                                        <div class="flex flex-col mb-3">
                                            <input type="password" name="password" class="form-control" aria-label="Password" value="secret" >
                        ...
                        <div
                            ...
                            <div class="position-relative h-100 m-3 px-7 d-flex flex-column justify-content-center overflow-hidden"
                                 style="background-color: #990000; background-size: cover;">
